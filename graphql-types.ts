...
export type SiteSiteMetadata = {
  ...
  social?: Maybe<Social>;
  i18n?: Maybe<Array<Maybe<SiteI18nMetadataForLang>>>;
};
...
export type SiteI18nMetadataForLang = {
  lang?: Maybe<Language>;
  sitei18nMetadata?: Maybe<SiteI18nMetadata>;
  siteMetadata?: Maybe<SiteSiteMetadataI18nSiteMetadata>;
};

export type SiteSiteMetadataI18nSiteMetadata = {
  title?: Maybe<Scalars['String']>;
  author?: Maybe<SiteSiteMetadataI18nSiteMetadataAuthor>;
  description?: Maybe<Scalars['String']>;
};

export type SiteSiteMetadataI18nSiteMetadataAuthor = {
  name?: Maybe<Scalars['String']>;
  summary?: Maybe<Scalars['String']>;
};

export type SiteI18nMetadata = {
  author?: Maybe<Author>;
  title?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
};
...
export type FrontmatterFilterInput = {
  ...
  lang?: InputMaybe<LanguageQueryOperatorInput>;
};

export type LanguageQueryOperatorInput = {
  eq?: InputMaybe<Language>;
  ne?: InputMaybe<Language>;
  in?: InputMaybe<Array<InputMaybe<Language>>>;
  nin?: InputMaybe<Array<InputMaybe<Language>>>;
};
...
export type SiteSiteMetadataFilterInput = {
  ...
  i18n?: InputMaybe<SiteI18nMetadataForLangFilterListInput>;
};
...
export type SiteI18nMetadataForLangFilterListInput = {
  elemMatch?: InputMaybe<SiteI18nMetadataForLangFilterInput>;
};

export type SiteI18nMetadataForLangFilterInput = {
  lang?: InputMaybe<LanguageQueryOperatorInput>;
  sitei18nMetadata?: InputMaybe<SiteI18nMetadataFilterInput>;
  siteMetadata?: InputMaybe<SiteSiteMetadataI18nSiteMetadataFilterInput>;
};

export type SiteI18nMetadataFilterInput = {
  author?: InputMaybe<AuthorFilterInput>;
  title?: InputMaybe<StringQueryOperatorInput>;
  description?: InputMaybe<StringQueryOperatorInput>;
};

export type SiteSiteMetadataI18nSiteMetadataFilterInput = {
  title?: InputMaybe<StringQueryOperatorInput>;
  author?: InputMaybe<SiteSiteMetadataI18nSiteMetadataAuthorFilterInput>;
  description?: InputMaybe<StringQueryOperatorInput>;
};

export type SiteSiteMetadataI18nSiteMetadataAuthorFilterInput = {
  name?: InputMaybe<StringQueryOperatorInput>;
  summary?: InputMaybe<StringQueryOperatorInput>;
};
...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___i18n'
  | 'siteMetadata___i18n___lang'
  | 'siteMetadata___i18n___sitei18nMetadata___title'
  | 'siteMetadata___i18n___sitei18nMetadata___description'
  | 'siteMetadata___i18n___siteMetadata___title'
  | 'siteMetadata___i18n___siteMetadata___description'
  | 'port'
  | 'host'
  | 'id'
  | 'parent___id'
...
export type BioQueryQuery = { site?: { siteMetadata?: { i18n?: Array<{ lang?: Language | null, siteMetadata?: { author?: { name?: string | null, summary?: string | null } | null } | null } | null> | null } | null } | null };

export type SeoQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type SeoQueryQuery = { site?: { siteMetadata?: { i18n?: Array<{ lang?: Language | null, siteMetadata?: { title?: string | null, description?: string | null, author?: { name?: string | null, summary?: string | null } | null } | null } | null> | null } | null } | null };

export type BlogHomeQueryVariables = Exact<{
...
export type BlogHomeQuery = { site?: { siteMetadata?: { title?: string | null } | null } | null, allMarkdownRemark: { nodes: Array<{ excerpt?: string | null, fields?: { slug?: string | null } | null, frontmatter?: { date?: any | null, title?: string | null, description?: string | null } | null }> } };
